/**
 * Shared recommender core.
 * Contains deterministic heuristics, scoring helpers and outfit assembly logic that can run
 * both on the CLI (Node) and inside the Expo app without accessing Vertex AI directly.
 */
